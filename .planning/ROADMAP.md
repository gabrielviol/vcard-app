...
- [x] **Phase 2: Cartão Público no Ar** - Cartão público acessível por slug, resiliente a cold start (ISR + pré-aquecimento + keep-alive), com QR pronto para circular (completed 2026-08-18; BRAND-01/domínio próprio deferido por escolha do usuário — ver STATE.md Deferred Items)
...
- [x] 01-03-PLAN.md — Slice: criar o cartão com slug único (reservados + unicidade no banco) e identidade
...
- [x] 02-05-PLAN.md — Slice: backend em produção (Render + Neon) + keep-alive externo

**Wave 3** *(blocked on Wave 2 completion)*

- [x] 02-06-PLAN.md — Slice: frontend em produção no domínio próprio + verificação end-to-end
...
| 2. Cartão Público no Ar | 6/6 | Complete   | 2026-08-18 |
